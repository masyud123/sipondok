            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('ortu/santri') ?>">Santri</a>
                        <!-- Berisi data nama santri, nis, alamat, data orang tua,kelas santri, status santri, tgl masuk -->
                        <a class="collapse-item" href="<?php echo base_url('ortu/rapor_santri') ?>">Rapor</a>
                        <!-- Berisi Rapor Santri (include) -->
                        <a class="collapse-item" href="#" data-toggle="modal" data-target="#tambah_saran">Saran
                            Pengaduan</a>
                        <!-- Input Saran pengaduan -->
                        <a class=" collapse-item" href="<?php echo base_url('ortu/janji') ?>">Janji Temu</a>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class=" modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?php echo base_url('ortu/saran/tambah_saran'); ?>" method="post"
